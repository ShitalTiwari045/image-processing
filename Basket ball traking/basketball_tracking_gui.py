...
class BasketballTrackingApp:
    def __init__(self, root):
        ...
        self.hsvVals = {'hmin': 17, 'smin': 102, 'vmin': 40, 'hmax': 80, 'smax': 255, 'vmax': 255}
        
        # Setup GUI
        self.setup_gui()
        
        # Initialize data file (CSV format)
        self.data_file = "basketball_trajectories.csv"
    ...
    def setup_gui(self):
        ...
        # Create parameter entry fields - Added 'Start Angle'
        self.params = {}
        param_entries = [
            ...
            ("Start Angle", "start_angle", "30"),  # New parameter
        ...
        self.results_frame = ttk.LabelFrame(self.right_panel, text="Shot Result")
        self.results_frame.pack(fill=tk.X, padx=5, pady=5, ipady=5)
        
        results_inner_frame = ttk.Frame(self.results_frame)
        results_inner_frame.pack(fill=tk.X, padx=5, pady=5)
        
        self.shot_result_var = tk.StringVar(value="silent_shot")
        
        self.shot_options = [
            ("Silent Shot", "silent_shot"),
            ("Ring Touch Shot", "ring_touch"),
            ("Backboard Shot", "backboard_shot"),
            ("Close Failure", "close_failure"),
            ("Failure", "failure")
        ]
        
        for i, (label_text, value) in enumerate(self.shot_options):
            radio_btn = ttk.Radiobutton(results_inner_frame, text=label_text, 
                                       variable=self.shot_result_var, value=value)
            radio_btn.grid(row=i, column=0, sticky='w', padx=5, pady=2)
    ...
    def detect_basketball(self, img):
        """Detect basketball using color filtering and contour detection"""
        # Convert to HSV
    ...
    def save_data(self):
        ...
        try:
            shot_result = self.shot_result_var.get()
            shot_result_names = {
                "silent_shot": "Silent Shot",
                "ring_touch": "Ring Touch Shot", 
                "backboard_shot": "Backboard Shot",
                "close_failure": "Close Failure",
                "failure": "Failure"
            }
            ...
            data = {
                ...
                "Shot Result": shot_result_names[shot_result],
    ...
    def check_create_file(self):
        ...
        if not os.path.exists(self.data_file):
            headers = [
                ...
                "Shoot Angle", "Velocity", "Acceleration", "Shot Result",
